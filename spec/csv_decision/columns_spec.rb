...
describe CSVDecision::Columns do
  ...
  context 'recognises format: columns' do
    it 'correctly parses format: columns' do
    ...
    it 'raises an error if a formatter is not supplied' do
      ...
      expect { CSVDecision.parse(data, formatter: nil) }
        .to raise_error(ArgumentError,
                        'table with format: columns has no formatter: argument supplied')
